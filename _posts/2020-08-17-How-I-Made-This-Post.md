...
So, some benefits of static site static sites are they are fast and secure, posting can be inexpensive or completely free. One can track and coordinate versioning with GitHub. And they exist outside of content management frameworks which are between the user and the HTML you're trying to share.
...
So what's cool about this is because netlify is looking at my GitHub repository, so every time I want to update my blog, I just get push to my master branch, it will update the live site, which is, easy enough for me to understand. And that's the how we got here. Thank you for your time.
